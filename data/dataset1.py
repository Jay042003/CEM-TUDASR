...
class unpaired_dataset(data.Dataset):
    def __init__(self, args, phase='train'):
        self.args = args
        self.images_source = glob.glob(os.path.join("/media/admin1/DL/CapsNetwork/Unsupervised/DATASET/Conventional/Train/HR", '*.jpg'))
        # self.images_source = glob.glob(os.path.join("/cluster/home/jaykk/CapsNetwork/dataset/WCE/Test/HR/", '*.jpg'))
        ...
        self.images_target = glob.glob(os.path.join("/media/admin1/DL/CapsNetwork/Unsupervised/DATASET/Train/HR", '*.*'))
        # self.images_target = glob.glob(os.path.join("/cluster/home/jaykk/CapsNetwork/dataset/WCE/Test/LR_bicubic/", '*.*'))
 
        if phase == 'train':
            self.images_source = self.images_source[:-33]
        else:
            self.images_source = glob.glob(os.path.join("/media/admin1/DL/CapsNetwork/Unsupervised/DATASET/Conventional/Train/HR/", '*.jpg'))#self.images_source[:]
            self.images_target = glob.glob(os.path.join("/media/admin1/DL/CapsNetwork/Unsupervised/DATASET/Train/HR/", '*.*'))
